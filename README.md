...
👉🏼https://paupau77.github.io/Proyecto-Hugo-Medidor-de-Salinidad-con-Arduino-UNO/

Desde ahí se puede acceder a:

-📘 Rama main – versión base del dispositivo

-🧪 Rama VersionAgosto2025 – versión experimental avanzada

La web presenta el proyecto de forma clara, visual y accesible, separando la documentación técnica del código fuente.
